...
$coupons = get_web_page("https://api.cloud.appcelerator.com/v1/objects/Coupon/query.json?key=lhQJqbLTYXMjoxwjQBDnZ8QnfalByWLX&pretty_json=true", array(
    "where" => '{"user_id":"' . $user->id . '"}'
), $info['cookies']);


echo $coupons["content"];
